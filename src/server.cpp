...
String getPage(String content) {
  ...
  html += ".container {border-radius:5px;padding:20px;background-color:#1e1e2e;}";
  html += "</style>";
  html += "</head>";
...
void handleHome() {
  ...
  content += "<style>";
  content += "button { background-color:#e5c890;color:#292c3c;border-radius:5px;border:none;padding:5px;}";
...
void handleToggle() {
  state = !state;
  String content = "<i>successful! redirecting...</i>";
